...
export function KoreaFlag() {
  return (
    <SvgIcon>
      <svg width="24" height="24" viewBox="-24 -24 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g transform="rotate(33.69006752598)">
        <path fill="#E31D1C" d="M12 0a18 18 0 11-36 0 24 24 0 1148 0"/>
        <path fill="#2E42A5" d="M0 0a12 12 0 1124 0 24 24 0 11-48 0 12 12 0 1024 0"/>
      </g>
      </svg>
    </SvgIcon>
  );
